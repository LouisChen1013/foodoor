...
export default class Cart extends Component {
  static navigationOptions = ({ navigation }) => {
    return {
      headerLeft: () => <NavHeaderLeft toScreen={"Food"} buttonText={"Back"} />,
    };
  };
  ...
  sendEmail = () => {
    ...
    for (var i = 0; i < this.state.dataCart.length; i++) {
      email_cart.push(
        "Name: " +
          this.state.dataCart[i].food.name +
          " " +
          "Quantity: " +
    ...
    let body = {
      personalizations: [
        {
          to: [{ email: firebase.auth().currentUser.email }],
          subject: "Thank you for your order at Foodoor",
        },
      ],
      from: { email: "chenhonglin1013@hotmail.com" },
      content: [
        {
          type: "text/plain",
          value:
            "We've received your order, and the restaurant will have your food ready soon. Please be patient, and we will deliver the food to you as soon as possible. Below is your order summary\n\n" +
            email_cart_string +
            "\nTotal Price: " +
            total_price +
      ...
      <View style={styles.container}>
        <View style={styles.middleContainer}>
          ...
          >
            ...
            <Text
              style={{ fontSize: 32, fontWeight: "bold", color: "#339e66ff" }}
            >
              Your Cart
            </Text>
  ...
  emptyCart = () => {
    Alert.alert("Thank you!", "Please check your email for your order!", [
      {
        text: "Got it!",
        onPress: () => {
          this.setState({
